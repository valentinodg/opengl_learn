...
int main()
{
    ...
    Shader lightingShader("10.3.multiple_lights.vertex", "10.3.multiple_lights.fragment");
    Shader lampShader("10.3.lamp.vertex", "10.3.lamp.fragment");
    ...
    {   
        ...
        /*
            ...
            this can be done more code-friendly by defining light types as classes and set their values in there, or by using a more efficient uniform approach, "Uniform buffer objects" (see "Advanced GLSL")
        */
        //directional light

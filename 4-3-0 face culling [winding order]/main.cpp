...
int main()
{
    ...
    //let's enable the depth testing & blending
    glEnable(GL_DEPTH_TEST);
    glEnable(GL_BLEND);
    glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
    //let's enable face culling
    ...
    //remember: to specify vertices in a counter-clockwise winding order you need to visualize the triangle as if you're in  front of it and from that point of view, is where you set their order
    float cubeVertices[] = {
        // Back face
    ...
    //load textures
    unsigned int cubeTexture = loadTexture("./textures/wood.png");

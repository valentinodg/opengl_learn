...
int main()
{
    ...
    Shader lightingShader("10.2.light_casters.vertex", "10.2.light_casters.fragment");
    Shader lampShader("10.2.lamp.vertex", "10.2.lamp.fragment");
    ...
    {   
        ...
        //let's configure the diffuse intensity slightly higher
        //(the right lighting confitions differ with each lighting method and environment)
        ...
        {
            //let's calculate the model matrix for each object and pass it to shader before drawing
            glm::mat4 model = glm::mat4(1.0f);

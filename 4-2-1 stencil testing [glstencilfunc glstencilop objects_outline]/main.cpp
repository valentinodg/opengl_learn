...
int main()
{
    ...
    glDepthFunc(GL_LESS);
    //let's enable stencil test
    glEnable(GL_STENCIL_TEST);
    glStencilFunc(GL_NOTEQUAL, 1, 0xFF);
    glStencilOp(GL_KEEP, GL_KEEP, GL_REPLACE);
    
    //build and compile the shader program
    Shader shader("13.1.stencil_testing.vertex", "13.1.stencil_testing.fragment");
    Shader shaderSingleColor("13.1.stencil_testing.vertex", "13.1.outline_border.fragment");
    ...
    {   
        ...
        //let's clear also the stencil buffer [important]
        ...
        //let's draw floor as normal
        //but don't write the floor to the stencul buffer, we only care about the containers
        ...
        //the parts of the buffer that are 1 are not drawn, thus only drawing the objects size differences, making it look like borders
        glStencilFunc(GL_NOTEQUAL, 1, 0xFF);
        glStencilMask(0x00);

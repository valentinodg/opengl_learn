...
int main()
{
    ...
    Shader asteroidShader("18.1.asteroids.vertex", "18.1.asteroids.fragment");
    Shader planetShader("18.1.planet.vertex", "18.1.planet.fragment");
    ...
    //set transformation matrices as an instance veertex attribute (with divisor 1)

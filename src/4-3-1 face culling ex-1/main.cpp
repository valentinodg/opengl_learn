...
int main()
{
    ...
    glCullFace(GL_BACK);
    //triangles defined by a clockwise ordering are now 'front facing' triangles so the cube is rendered as normal
    glFrontFace(GL_CW);
    ...
    //now let's re-define the vertex data by specifying each triangle in clockwise order
    float cubeVertices[] = {
        // Back face
